...
wta_matches_2018 <- read.csv("./wta_matches_2018.csv", header=TRUE)
wta_matches_2019 <- read.csv("./wta_matches_2019.csv", header=TRUE)
...
wta_rank <- read.csv("./wta_rankings_10s.csv", header=FALSE)
